...
function ProfilePokemonPage() {
    ...
    const handleShowButton = () => {
        ...
        if (findFavorite) {
            return (
                <button className='w-full text-lg border py-1 mb-2 rounded-full border-[#ef4444] text-red-500' value={profilePokemon} onClick={() => deleteFavorite(findFavorite.id)}>delete from Favorite</button>
            )
        } else {
            return (
                <button className='w-full text-lg border py-1 mb-2 rounded-full border-[#466E9B] text-[#B3EAFE]' value={profilePokemon} onClick={() => addFavorite()}>add to Favorite</button>
            )
        }
    }
                            ...
                            <div className='grid grid-cols-3 mt-14'>
                                <div className='grid justify-center gap-y-10'>
                                    ...
                                    <div className='grid gap-3'>
                                        {handleShowButton()}
                                        <Link to='/favorite'><button className='w-full text-lg border py-1 mb-2 rounded-full'>Favorite Page</button></Link>
                                    </div>
                                </div>
